...
def argsparsing():
    parser=argparse.ArgumentParser(description = "Pass git repo to bundle into an RPM")
    parser.add_argument('--repo', action='store', help="your git repo <git@your-git-repo>")
